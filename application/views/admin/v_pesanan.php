    ...
    <?php $this->load->view('menu');?> <!--Include menu-->
      <div class="col-md-12">
        <div class="row">
          ...
          <center><button class="btn-info" style="height: 30px"><?php echo anchor('ctrl_admin/tambah_pesanan','Tambah Data'); ?></button></center><br>
          <table class="table table-striped table-bordered">
            ...
            <tr>
              ...
              <td>
                  <?php echo anchor('ctrl_admin/edit/'.$s->id_pesanan,'Edit'); ?>
                  <?php echo anchor('ctrl_admin/hapus/'.$s->id_pesanan,'Hapus'); ?>
              </td>
            </tr>
            <?php $i++;}?>
          </table>
